...
{
    public class ShootingStarPowerup : PowerupBase
    {
        [Header("Orbital Settings")]
        [SerializeField] private ShootingStarProjectile projectilePrefab;
        ...
        private List<ShootingStarProjectile> activeProjectiles = new List<ShootingStarProjectile>();
        ...
        private void SpawnProjectile()
        {
            ...
            // Create projectile
            ShootingStarProjectile projectile = Instantiate(projectilePrefab, transform);
